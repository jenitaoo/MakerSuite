...
// fields the Etsy API accepts for core listing updates
...
// fields for internal product updates
...
export default function EditProductListing() {
  ...
  const { product, externalListings, loading, error } = useProductWithListings(id);
  ...
  if (error || !product || !internal || !etsy) {
    ...
    <div className="edit-product">
        ...
        {/* editor — hidden when preview is open */}
        {!previewOpen && (
        ...
        {/* etsy preview — shown when previewOpen is true */}
        {previewOpen && (
